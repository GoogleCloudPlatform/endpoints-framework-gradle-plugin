...
public class DiscoveryDocTaskConfiguration implements EndpointsTaskConfiguration {
  ...
  public List<String> getActionSpecificParams(File outputDirectory) {
    return Arrays.asList(GetDiscoveryDocAction.NAME, "-o", outputDirectory.getPath());
  }
}
