...
public class OpenApiDocTaskConfiguration implements EndpointsTaskConfiguration {
  ...
  public List<String> getActionSpecificParams(File outputDirectory) {
    return Arrays.asList(
        GetOpenApiDocAction.NAME, "-o", new File(outputDirectory, "openapi.json").getPath());
  }
}
