 ...
 */
public class GenerateClientLibsTask extends AbstractGenerateActionTask {
  ...
  // affect anything.
  public GenerateClientLibsTask() {
    super(GetClientLibAction.NAME, false, "-l", "java", "-bs", "gradle");
  }
